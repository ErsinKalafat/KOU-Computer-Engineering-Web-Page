...
$sql = $baglan->query("SELECT id,baslik,icerik,ekleyen,tarih FROM duyurutablosu WHERE kategori='haberveetkinlikler' ORDER BY tarih DESC");
...
while ($sonuc = $sql->fetch_assoc()) {
    ...
    echo "    <a style=\"color:#BB0253;  \"data-toggle=\"collapse\" href=\"#$idsonucu\" aria-expanded=\"false\">$basliksonucu</a>";
    echo "    <div class=\"collapse\" id=$idsonucu>";
    echo "        <div class=\"kategoriyazi\">$iceriksonucu</div>";
    echo "    </div>";
    echo "    <div style=\"color:green\";> $ekleyensonucu";
    echo "        <div style=\"color:#BB0253; font-size:40px; float:right;\";> $gunCustom</div>";
    echo "    </div>";
